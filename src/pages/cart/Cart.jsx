...
function Cart() {
  ...
  return (
    <Layout>
      ...
      >
        <h1 className="mb-10 text-center text-2xl font-bold fade-down">Cart Items</h1>
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
          <div className="rounded-lg md:w-2/3 fade-down">
            {cartItems.map((item,index) => {
              const { title, id,price, discountedPrice, description, imageUrl } = item;
                ...
                >
                  ...
                  <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                    <div className="mt-5 sm:mt-0">
                      ...
                      >
                        ₹{discountPrice} <span className="font-normal line-through text-gray-500 text-lg">₹{price}</span>
                      </p>
          ...
          >
            <p
              ...
              <p
                ...
                style={{ color: mode === "dark" ? "white" : "" }}
              >
                Know more about <Link to="/nopage" className="text-pink-700 hover:text-pink-500"> Handlooms</Link>
              </p>
          </div>
         </div> 
      </div>
